...
SELECT Student.LastName, COUNT(AssignedExercise.StudentId) AS 'Number of Assigned Exercises' FROM AssignedExercise LEFT JOIN Student ON AssignedExercise.StudentId = Student.Id GROUP BY Student.LastName;
